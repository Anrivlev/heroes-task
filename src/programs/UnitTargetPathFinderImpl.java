...
public class UnitTargetPathFinderImpl implements UnitTargetPathFinder {
    ...
    // Сложность:  O(n * m * log(n * m)), где n - ширина, m - высота поля
    @Override
    ...
    private void exploreNeighbors(EdgeDistance current, Set<String> occupiedCells, int[][] distance,
        ...
        for (int[] dir : DIRECTIONS) {
            ...
            if (isValid(neighborX, neighborY, occupiedCells)) {
                ...
                if (!queue.contains(new EdgeDistance(neighborX, neighborY, newDistance))
                        && newDistance < distance[neighborX][neighborY]) {
